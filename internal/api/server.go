...
func (s *Server) routes() http.Handler {
	...
	mux.Handle("PUT /v1/owner/arenas/{arenaID}", protected(s.handleUpdateArena))
	...
	mux.Handle("PUT /v1/teams/{teamID}", protected(s.handleUpdateTeam))
	...
	mux.Handle("PUT /v1/calls/{callID}", protected(s.handleUpdateCall))
